...
G_BEGIN_DECLS
#define GST_TYPE_VMETAXVSINK \
  (gst_vmetaxvsink_get_type())
#define GST_VMETAXVSINK(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GST_TYPE_VMETAXVSINK, GstVmetaXvSink))
#define GST_VMETAXVSINK_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass), GST_TYPE_VMETAXVSINK, GstVmetaXvSinkClass))
#define GST_IS_VMETAXVSINK(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GST_TYPE_VMETAXVSINK))
#define GST_IS_VMETAXVSINK_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GST_TYPE_VMETAXVSINK))
typedef struct _GstXContext GstXContext;
typedef struct _GstXWindow GstXWindow;
typedef struct _GstVmetaXvFormat GstVmetaXvFormat;

typedef struct _GstVmetaXvSink GstVmetaXvSink;
typedef struct _GstVmetaXvSinkClass GstVmetaXvSinkClass;
 ...
 * @cur_image: a reference to the last #GstVmetaXv that was put to @xwindow. It
 ...
 * @image_pool: a list of #GstVmetaXvBuffer that could be reused at next buffer
 * allocation call
 ...
 *
 * The #GstVmetaXvSink data structure.
 */
struct _GstVmetaXvSink
{
  /* Our element stuff */
...
struct _GstVmetaXvSinkClass
{
  GstVideoSinkClass parent_class;
};

GType gst_vmetaxvsink_get_type (void);

G_END_DECLS
#endif /* __GST_VMETAXVSINK_H__ */
